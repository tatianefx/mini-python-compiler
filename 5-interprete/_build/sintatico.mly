...
loopFOR:
	| FOR id = ID IN RANGE APAR exprcomeco = exprLogicoAritmetica VIRG exprfim = exprLogicoAritmetica FPAR DPONTOS NOVALINHA INDENTA stm = comandos DEDENTA 	{ FORLOOP(EXPVAR id,exprcomeco,exprfim,stm)}
	;
