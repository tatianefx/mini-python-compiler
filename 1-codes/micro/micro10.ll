...
@.str.2 = private unnamed_addr constant [22 x i8] c"O fatorial de %d e %d\00", align 1
...
define i32 @main() #0 {
  ...
  %7 = call i32 @fatorial(i32 %6)
  store i32 %7, i32* %3, align 4
  %8 = load i32, i32* %2, align 4
  %9 = load i32, i32* %3, align 4
  %10 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([22 x i8], [22 x i8]* @.str.2, i32 0, i32 0), i32 %8, i32 %9)
  ret i32 0
}
