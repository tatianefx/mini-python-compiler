...
@.str.2 = private unnamed_addr constant [63 x i8] c"Ao total, foram digitados %d numeros no intervalotre 10 e 150.\00", align 1
...
; <label>:24:                                     ; preds = %5
  ...
  %26 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([63 x i8], [63 x i8]* @.str.2, i32 0, i32 0), i32 %25)
  ret i32 0
}
