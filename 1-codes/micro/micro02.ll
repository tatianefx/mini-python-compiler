...
@.str.3 = private unnamed_addr constant [47 x i8] c"O primeiro numero %d e maior que o segundo %d.\00", align 1
...
; <label>:11:                                     ; preds = %0
  ...
  %14 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([47 x i8], [47 x i8]* @.str.3, i32 0, i32 0), i32 %12, i32 %13)
  br label %19

; <label>:15:                                     ; preds = %0
  %16 = load i32, i32* %3, align 4
  %17 = load i32, i32* %2, align 4
  %18 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([47 x i8], [47 x i8]* @.str.3, i32 0, i32 0), i32 %16, i32 %17)
  br label %19
