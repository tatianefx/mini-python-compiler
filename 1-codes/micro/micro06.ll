...
@.str = private unnamed_addr constant [28 x i8] c"Digite um numero de 1 a 5: \00", align 1
...
@.str.7 = private unnamed_addr constant [19 x i8] c"Numero Invalido!!!\00", align 1
...
; <label>:17:                                     ; preds = %14
  %18 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.4, i32 0, i32 0))
  br label %33
...
; <label>:29:                                     ; preds = %24
  %30 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.7, i32 0, i32 0))
  br label %31
